  ...
  const reasons = [
    {
      ...
      icon: <CheckCircle className="text-gray-800 w-10 h-10 mx-auto mb-3" />,
    },
    {
      title: "Prime Locations",
      description: "We focus on high-value properties in strategic and sought-after areas.",
      icon: <MapPin className="text-gray-800 w-10 h-10 mx-auto mb-3" />,
    },
    {
      title: "Transparent Deals",
      description: "Clear, honest, and fair transactions for all our clients.",
      icon: <DollarSign className="text-gray-800 w-10 h-10 mx-auto mb-3" />,
    },
    {
      title: "24/7 Support",
      description: "Our team is always available to assist with your real estate needs.",
      icon: <Clock className="text-gray-800 w-10 h-10 mx-auto mb-3" />,
    },
  ];

  return (
    <div className="bg-gray-50 py-8 px-10">
      {/* ===== OUR SERVICES ===== */}
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {services.map((service) => (
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed text-justify">{service.description}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="grid gap-8 md:grid-cols-4 ">
          {reasons.map((item) => (
            ...
            >
              ...
              <p className="text-gray-500 text-justify leading-relaxed ">{item.description}</p>
            </div>
          ))}
        </div>
      </section>
