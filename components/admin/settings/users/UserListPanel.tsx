...
export default function UserListPanel() {
  ...
  return (
    <div className="p-4 max-w-6xl flex-1 flex flex-col mx-auto mt-6">
      ...
      <div className="mb-6 flex flex-col md:flex-row justify-between gap-3">
        <div className="relative w-full md:w-1/3">
          ...
          <input
            ...
            className="pl-9 pr-3 py-2 w-full border rounded-lg text-sm shadow-sm focus:ring-2 focus:ring-blue-500 outline-none"
            value={searchTerm}
            onChange={(e) => {
        ...
        <button
          onClick={exportToCSV}
          className="bg-blue-600 text-white px-5 py-2 rounded-lg font-medium hover:bg-blue-500 transition-colors shadow-sm"
        >
          Export CSV
        </button>
      </div>
      ...
      {/* Table (desktop) */}
      <div className="hidden md:block border rounded-lg shadow-sm bg-black overflow-x-auto">
        <table className="min-w-full text-sm">
          <thead className="bg-black text-xs uppercase text-gray-100">
            <tr>
              {[
                "Photo",
                "Full Name",
          ...
          <tbody>
            {paginatedUsers.map((user) => (
              <tr
                key={user._id}
                className="border-t hover:bg-gray-50 hover:text-black transition"
              >
      ...
      <div className="md:hidden space-y-5 mt-6">
        {paginatedUsers.map((user) => (
          <div
            key={user._id}
            className="border rounded-lg p-4 shadow-sm bg-black"
          >
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-8 mb-12">
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="px-4 py-2 bg-black border border-white rounded disabled:opacity-50"
          >
            Prev
          </button>
