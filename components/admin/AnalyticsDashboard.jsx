...
export default function AnalyticsDashboard() {
  ...
  return (
    <div className="mt-8">
      ...
      <div className="mt-2 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-5 sm:py-8 space-y-6 sm:space-y-8 
        bg-white dark:bg-black rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="px-5 py-2 text-sm font-medium text-blue-600 border border-blue-300 rounded-lg hover:bg-blue-50 transition-all"
          >
...
const StatCard = ({ label, value, accent }) => (
  <div className="relative bg-white dark:bg-black rounded-2xl border border-gray-100 dark:border-gray-800 p-6 shadow-sm hover:shadow-md transition-all duration-300">
    <div
...
const EngagementChart = ({ combinedData, stats, mode, setMode, loading }) => (
  <div className="bg-white dark:bg-black rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
...
const TopPages = ({ topPages }) => {
  ...
  return (
    <div className="bg-white dark:bg-black rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 overflow-x-auto">
