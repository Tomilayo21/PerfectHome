...
export default function PropertyListPanel() {
  ...
  useEffect(() => {
    if (editableProperty) {
        setEditableProperty((prev) => ({ ...prev, features }));
    }
    }, [features]);
      ...
      {/* Edit Modal */}
        {openProperty && editableProperty && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center px-4">
                <div className="bg-black border border-white rounded-2xl p-6 max-w-4xl w-full relative shadow-2xl space-y-6 text-sm max-h-[90vh] overflow-y-auto">
                ...
                {/* Title */}
                <h2 className="text-xl font-bold text-gray-100 border-b pb-3">
                    Edit Property
                </h2>
                ...
                <div className="space-y-4">
                    ...
                    <input
                        type="text"
                        value={editableProperty.price.toLocaleString()}
                        onChange={(e) => {
                            const rawValue = e.target.value.replace(/,/g, "");
                            setEditableProperty({ ...editableProperty, price: Number(rawValue) });
                        }}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                        />
                    ...
                    {features.length > 0 ? (
                        ...
                        {features.map((feature, idx) => (
                            <span
                            key={idx}
                            className="group flex items-center gap-2 px-3 py-1.5 bg-orange-50 text-blue-700 border border-orange-200 rounded-full text-sm font-medium hover:bg-blue-100 transition"
                            >
                            <span>{feature}</span>
                            <button
                                type="button"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-1">Toilets</label>
                            <input
                            type="number"
                ...
                <div className="border-t pt-4 space-y-4">
                    ...
                    {/* Add Image */}
                    <label className="w-24 h-24 border border-dashed border-gray-400 rounded-lg cursor-pointer flex items-center justify-center hover:border-blue-500 hover:text-blue-500 transition">
                        <input
                        type="file"
                        hidden
                        accept="image/*"
                    ...
                    <div className="flex flex-wrap items-start gap-3">
                        ...
                        {/* Add Video */}
                        <label className="w-32 h-24 border border-dashed border-gray-400 rounded-lg cursor-pointer flex items-center justify-center hover:border-blue-500 hover:text-blue-500 transition">
                        <input
                            type="file"
                            hidden
                            accept="video/*"
