...
const AddProperty = () => {
  ...
  return (
    ...
    >
        ...
        <h1 className="text-3xl font-medium text-white">Add New Property</h1>
        ...
        {/* Upload Section */}
        <section className="bg-black rounded-md  shadow-md border border-gray-200 p-6 space-y-6">
            <h2 className="text-xl font-semibold text-gray-100 border-b pb-3">Media Upload</h2>

            {/* Images */}
            <div>
                <h3 className="text-base font-medium text-gray-100 mb-2">Property Images</h3>
            ...
            {/* Videos */}
            <div>
                <h3 className="text-base font-medium text-gray-100 mb-2">Property Videos (Optional)</h3>
                <p className="text-sm text-gray-400 mb-4">Upload up to 3 videos (max 200MB each).</p>
        ...
        {/* Property Details */}
        <section className="bg-black rounded-md shadow-md border border-gray-200 p-6 space-y-6">
            <h2 className="text-xl font-semibold text-gray-100 border-b pb-3">Property Details</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <input
                    ...
                    className="input-style"
                    value={price.toLocaleString()} // display with commas
                    onChange={(e) => {
                        const rawValue = e.target.value.replace(/,/g, ""); // remove commas
                        setPrice(Number(rawValue)); // store as number
                    }}
                    required
                />
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-300">Property Features</h3>
                    {features.length > 0 && (
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    <button
                        type="button"
                        className="relative flex items-center justify-center w-11 h-11 rounded-full bg-blue-600 hover:from-blue-700 hover:to-blue-600 text-white shadow-md transition-all duration-200 hover:shadow-lg active:scale-95"
                        onClick={() => {
            ...
            <div>
                ...
                rows="4"
                className="input-style resize-none mt-2"
                value={description}
        ...
        {/* Location Section */}
        <section className="bg-black rounded-md shadow-md border border-gray-200 p-6 space-y-6">
            <h2 className="text-xl font-semibold text-gray-100 border-b pb-3">Location</h2>
        ...
        <section className="bg-black rounded-md shadow-md border border-gray-200 p-6">
            <h2 className="text-xl font-semibold text-gray-100 border-b pb-3 mb-6">Specifications</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                ...
                <div>
                <label className="text-sm font-medium text-gray-300">Toilets</label>
                <input
                    type="number"
                    placeholder="2"
                    className="input-style"
                ...
                <div>
                <label className="text-sm font-medium text-gray-300">Area (sqft)</label>
                <input
                    type="text"
        ...
        <div className="flex justify-end">
            <button
                type="submit"
                disabled={uploading}
                className="px-8 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 shadow transition disabled:opacity-50"
            >
