...
const FooterSection = ({ title, children }) => {
  ...
  return (
    <div className="border-b border-gray-200 dark:border-gray-200 md:border-none pb-4 md:pb-0">
      {/* Section Header */}
      <button
        className="w-full flex items-center justify-between md:justify-start md:cursor-default text-left font-normal text-white dark:text-white text-lg tracking-wide"
