    ...
    <div className="relative" ref={menuRef}>
        ...
        <div className="hidden md:block absolute left-1/2 top-12 transform -translate-x-1/2 w-72 bg-white dark:bg-black rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
          ...
          <div className="flex flex-col py-2">
            ...
            <button
              ...
              className="flex items-center gap-3 px-5 py-3 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900 dark:hover:text-white transition"
            >
      ...
      <Transition show={mobileMenuOpen} as={Fragment}>
        ...
        >
          ...
          >
            <Dialog.Panel className="relative z-5000 w-full max-w-md mx-auto rounded-2xl border dark:border-white bg-white dark:bg-black shadow-2xl overflow-hidden">
              {/* Profile Header */}
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <button
                      ...
                      className="bg-blue-600 text-sm text-white px-5 py-2 rounded-full hover:bg-blue-700 transition"
                    >
