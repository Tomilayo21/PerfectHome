  ...
  if (loading) {
    return (
      <>
        <Navbar />
        <ProductSlider />
        <div className="w-full flex bg-white justify-center items-center h-96 text-lg text-gray-600">
          Loading properties...
        </div>
        <Footer />
      </>
          ...
          <div className="w-full flex flex-col items-center justify-center mt-20 mb-20 text-gray-600 text-center">
            ...
            <p className="text-sm text-gray-500 mt-2 max-w-md">
              {searchQuery || type || category
                ? "Try changing your filters or clearing the search to see more listings."
