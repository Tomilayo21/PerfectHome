...
export default function SignupPage() {
  ...
  // Updated cancel handler: closes modal visually but keeps access blocked
  const handleUnlockCancel = () => {
    setShowUnlockPrompt(false); // visually hide modal
    // Note: superAdminVerified is still false, so Signup cannot render
  };

  if (!mounted) return null;

  // Show unlock modal if prompt is active OR if not verified
  ...
  // If not verified and modal is closed, show a locked message
