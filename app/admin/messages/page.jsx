...
const AdminMessagesDashboard = () => {
  ...
  useEffect(() => {
    fetchReplies(); // Fetch ONCE when the component loads
  }, []);

  useEffect(() => {
    fetchMessages(); // Fetch messages when the view changes
  }, [view]);
        ...
        {Object.entries(viewLabels).map(([key, label]) => (
          <button
            ...
            className={`px-4 py-2 rounded text-sm sm:text-base ${
              view === key ? "bg-blue-700/80 text-white" : "border"
            }`}
          >
            {label} (
              {({
      ...
      {view !== "replies" && (loading ? (
        ...
        <div className="space-y-4">
          {paginatedMessages.map((msg) => (
            ...
            >
              <div className="w-full max-w-md mx-auto bg-black p-4 rounded-md shadow space-y-1 text-sm sm:text-base">
                <input
                  type="checkbox"
     ...
     {openMessage && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center px-4">
          ...
          >
            ...
            <h2 className="text-lg font-bold text-black mb-2">{openMessage.subject}</h2>
            ...
            {view === "replies" ? (
              <>
                ...
                <p className="text-base text-gray-700 whitespace-pre-line">{openMessage.message}</p>
              </>
            ) : (
              <>
                <p className="text-sm text-gray-500 mb-1">
      ...
      {showReplyModal && replyTarget && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center px-4">
          ...
          >
            ...
            <h2 className="text-lg font-bold text-gray-700 mb-4">Reply to Message</h2>

            <div className="mb-2">
              <label className="block text-sm text-gray-700 font-medium">To</label>
              <input
                type="text"
                className="w-full border px-3 py-2 rounded text-gray-700 bg-gray-200 cursor-not-allowed"
            ...
            <div className="mb-2">
              <label className="block text-sm text-gray-700 font-medium">CC</label>
              <input
                type="text"
                className="w-full border px-3 text-gray-700 bg-gray-200 py-2 rounded"
                value={cc}
            ...
            <div className="mb-2">
              <label className="block text-sm text-gray-700 font-medium">Subject</label>
              <input
                type="text"
                className="w-full border px-3 text-gray-700 bg-gray-200 py-2 rounded"
                value={subject}
            ...
            <div className="mb-3">
              ...
              <textarea
                className="w-full border text-gray-700 bg-gray-200 p-2 rounded"
                rows={5}
                value={replyMessage}
