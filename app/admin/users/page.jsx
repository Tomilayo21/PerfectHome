            ...
            <AnimatePresence mode="wait">
              {userPanel === "main" && (
                ...
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <button onClick={() => setUserPanel("main")} className="flex items-center text-sm text-gray-100 hover:text-gray-300">
                ...
                >
                  ...
                  <button onClick={() => setUserPanel("broadcast")} className="bg-blue-600 text-white px-4 py-2 rounded">
                ...
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <button onClick={() => setUserPanel("subscribers")} className="flex items-center text-sm text-gray-100 hover:text-gray-300">
                    <ArrowLeft className="w-4 h-4 mr-1" /> Back
                  </button>
                  <ViewBroadcastButton />
                </motion.div>
